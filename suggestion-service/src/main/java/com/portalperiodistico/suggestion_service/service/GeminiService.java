...
public class GeminiService {
    ...
    // Nota: He corregido la URL para que no tenga espacios ni saltos de línea
    private static final String GEMINI_URL = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=";

    // Prompt por defecto (Respaldo si no hay nada en la BD)
    ...
    public String getSuggestions(List<String> trends) {
        ...
        // 1. Obtener el prompt de la BD (o usar el default)
